...
DD=~/Library/Developer/Xcode/DerivedData/Pronto
xcodegen generate -q
xcodebuild -project Pronto.xcodeproj -scheme Pronto -sdk iphonesimulator \
  -destination "id=$UDID" -derivedDataPath $DD build -quiet
xcrun simctl boot $UDID 2>/dev/null || true
xcrun simctl install $UDID $DD/Build/Products/Debug-iphonesimulator/Pronto.app
xcrun simctl launch $UDID com.pronto.app
